...
CountriesDeathsChina<-as.numeric(CountriesDeaths$China) #change from factor to numeric 
CountriesDeathsGermany<-as.numeric(CountriesDeaths$Germany)
...
The graph above shows the total number of 
