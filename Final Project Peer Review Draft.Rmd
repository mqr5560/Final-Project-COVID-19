...
GlobalConfirmedWide1<-
  t(GlobalConfirmedWide)
GlobalConfirmedWide1<-
  GlobalConfirmedWide1[,-1] #removes blank first column 
head(GlobalConfirmedWide1) #only showing output for this first one because they are long 
```
...
GlobalDeathsWide1<-
  t(GlobalDeathsWide)
GlobalDeathsWide1<-
  GlobalDeathsWide1[,-1] #removes blank first column 
```
...
GlobalRecoveredWide1<-
  t(GlobalRecoveredWide)
GlobalRecoveredWide1<-
  GlobalRecoveredWide1[,-1] #removes blank first column 
```
